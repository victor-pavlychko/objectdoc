...
typedef NS_ENUM(NSUInteger, PLClangTypeKind) {
    ...
    PLClangTypeKindHalf,
    PLClangTypeKindFloat16,
    PLClangTypeKindShortAccum,
    PLClangTypeKindAccum,
    PLClangTypeKindLongAccum,
    PLClangTypeKindUShortAccum,
    PLClangTypeKindUAccum,
    PLClangTypeKindULongAccum,
    PLClangTypeKindLastBuiltin = PLClangTypeKindULongAccum,
    PLClangTypeKindPipe,
    PLClangTypeKindOCLImage1dRO,
    PLClangTypeKindOCLImage1dArrayRO,
    PLClangTypeKindOCLImage1dBufferRO,
    PLClangTypeKindOCLImage2dRO,
    PLClangTypeKindOCLImage2dArrayRO,
    PLClangTypeKindOCLImage2dDepthRO,
    PLClangTypeKindOCLImage2dArrayDepthRO,
    PLClangTypeKindOCLImage2dMSAARO,
    PLClangTypeKindOCLImage2dArrayMSAARO,
    PLClangTypeKindOCLImage2dMSAADepthRO,
    PLClangTypeKindOCLImage2dArrayMSAADepthRO,
    PLClangTypeKindOCLImage3dRO,
    PLClangTypeKindOCLImage1dWO,
    PLClangTypeKindOCLImage1dArrayWO,
    PLClangTypeKindOCLImage1dBufferWO,
    PLClangTypeKindOCLImage2dWO,
    PLClangTypeKindOCLImage2dArrayWO,
    PLClangTypeKindOCLImage2dDepthWO,
    PLClangTypeKindOCLImage2dArrayDepthWO,
    PLClangTypeKindOCLImage2dMSAAWO,
    PLClangTypeKindOCLImage2dArrayMSAAWO,
    PLClangTypeKindOCLImage2dMSAADepthWO,
    PLClangTypeKindOCLImage2dArrayMSAADepthWO,
    PLClangTypeKindOCLImage3dWO,
    PLClangTypeKindOCLImage1dRW,
    PLClangTypeKindOCLImage1dArrayRW,
    PLClangTypeKindOCLImage1dBufferRW,
    PLClangTypeKindOCLImage2dRW,
    PLClangTypeKindOCLImage2dArrayRW,
    PLClangTypeKindOCLImage2dDepthRW,
    PLClangTypeKindOCLImage2dArrayDepthRW,
    PLClangTypeKindOCLImage2dMSAARW,
    PLClangTypeKindOCLImage2dArrayMSAARW,
    PLClangTypeKindOCLImage2dMSAADepthRW,
    PLClangTypeKindOCLImage2dArrayMSAADepthRW,
    PLClangTypeKindOCLImage3dRW,
    PLClangTypeKindOCLSampler,
    PLClangTypeKindOCLEvent,
    PLClangTypeKindOCLQueue,
    PLClangTypeKindOCLReserveID,
    PLClangTypeKindObjCObject,
    PLClangTypeKindObjCTypeParam,
    PLClangTypeKindAttributed,
    PLClangTypeKindOCLIntelSubgroupAVCMcePayload,
    PLClangTypeKindOCLIntelSubgroupAVCImePayload,
    PLClangTypeKindOCLIntelSubgroupAVCRefPayload,
    PLClangTypeKindOCLIntelSubgroupAVCSicPayload,
    PLClangTypeKindOCLIntelSubgroupAVCMceResult,
    PLClangTypeKindOCLIntelSubgroupAVCImeResult,
    PLClangTypeKindOCLIntelSubgroupAVCRefResult,
    PLClangTypeKindOCLIntelSubgroupAVCSicResult,
    PLClangTypeKindOCLIntelSubgroupAVCImeResultSingleRefStreamout,
    PLClangTypeKindOCLIntelSubgroupAVCImeResultDualRefStreamout,
    PLClangTypeKindOCLIntelSubgroupAVCImeSingleRefStreamin,
    PLClangTypeKindOCLIntelSubgroupAVCImeDualRefStreamin,
